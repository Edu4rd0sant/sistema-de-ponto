        ...
        <main class="flex-1 ml-64 flex flex-col min-h-screen relative overflow-hidden">
            ...
            <div class="p-8 pb-12 flex-1 relative z-10 flex flex-col">
                <div class="mb-6 flex justify-between items-center text-white">
                    ...
                    <button onclick="abrirModalNovaSolicitacao()" class="bg-blue-600 hover:bg-blue-500 text-white font-medium py-2 px-4 rounded-lg shadow-lg shadow-blue-500/20 transition-all hover:-translate-y-0.5 active:translate-y-0 flex items-center gap-2 text-sm">
            ...
            <div id="modalNovaSolicitacao" class="fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[100] items-center justify-center p-4 hidden opacity-0 transition-opacity duration-300">
                <div class="bg-slate-800 border border-slate-700 w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden transform scale-95 transition-transform duration-300 modal-content-anim">
                    ...
                    <form action="actions/criar_solicitacao.php" method="POST" id="formNovaSolicitacao" class="p-6">
