...
<body class="bg-slate-900 text-slate-200 font-sans min-h-screen">
        ...
        <main class="flex-1 lg:ml-64 flex flex-col min-h-screen">
            ...
            <div id="modalPonto" class="modal-overlay fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[100] items-center justify-center p-4">
                <div class="modal-content bg-slate-800 border border-slate-700 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                    ...
                    <form action="/admin/ponto/salvar" method="POST" id="formAlterarPonto" class="p-6 overflow-y-auto">
            ...
            <div id="modalNovoFuncionario" class="modal-overlay fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[100] items-center justify-center p-4">
                <div class="modal-content bg-slate-800 border border-slate-700 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                    ...
                    <form action="/admin/funcionario/criar" method="POST" id="formNovoFuncionario" class="p-6 overflow-y-auto">
            ...
            <div id="modalResetSenha" class="modal-overlay fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[100] items-center justify-center p-4">
                <div class="modal-content bg-slate-800 border border-slate-700 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                    ...
                    <form action="/admin/funcionario/resetar_senha" method="POST" id="formResetSenha" class="p-6 overflow-y-auto">
            ...
            <div id="modalEditarPermissoes" class="modal-overlay fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[100] items-center justify-center p-4">
                <div class="modal-content bg-slate-800 border border-slate-700 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                    ...
                    <form action="/admin/funcionario/editar_permissoes" method="POST" id="formEditarPermissoes" class="p-6 overflow-y-auto">
            ...
            <div id="modalExcluir" class="modal-overlay fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[100] items-center justify-center p-4">
                <div class="modal-content bg-slate-800 border border-slate-700 w-full max-w-md rounded-2xl shadow-2xl overflow-y-auto max-h-[90vh] p-6 text-center">
                    ...
                    <form action="/admin/funcionario/excluir" method="POST" id="formExcluir">
            ...
            <!-- MODAL RECUSA -->
            <div id="modalRecusa" class="modal-overlay fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[110] items-center justify-center p-4 hidden">
                <div class="modal-content bg-slate-800 border border-slate-700 w-full max-w-md rounded-2xl shadow-2xl p-6">
                    <div class="flex items-center gap-3 mb-4 text-red-400">
                        <i class="ph ph-warning-circle text-2xl"></i>
                        <h2 class="text-lg font-bold text-white">Recusar Solicitação</h2>
                    </div>
                    <p class="text-slate-400 text-sm mb-4">Por favor, informe ao colaborador o motivo do indeferimento (ex: data incorreta, falta documentação):</p>
                    
                    <input type="hidden" id="recusa_solicitacao_id">
                    <textarea id="recusa_motivo" rows="4" class="w-full bg-slate-900/50 border border-slate-700 rounded-lg p-3 text-slate-200 focus:outline-none focus:border-red-500 transition-colors text-sm placeholder:text-slate-600 resize-y mb-6" placeholder="Escreva a nota aqui..."></textarea>
                    
                    <div class="flex justify-end gap-3">
                        <button type="button" onclick="fecharModalRecusa()" class="px-5 py-2.5 text-sm font-medium text-slate-300 border border-slate-600 rounded-lg hover:bg-slate-700 hover:text-white transition-colors">Cancelar</button>
                        <button type="button" onclick="confirmarRecusa()" class="px-5 py-2.5 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-500 transition-colors shadow-lg shadow-red-500/20">Confirmar Recusa</button>
                    </div>
                </div>
            </div>
    ...
    <script>
                    ...
                    <li class="bg-slate-900/50 border border-slate-700/50 rounded-lg p-4 flex gap-4 transition-colors hover:bg-slate-800">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex gap-2 justify-end">
                                ...
                                <button onclick="abrirModalRecusa(${sol.id})" class="px-3 py-1.5 bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/20 rounded md:text-xs text-[11px] font-medium transition-colors flex items-center gap-1">
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (urlParams.get('open_solicitacoes') === '1') {
                if (typeof abrirModalSolicitacoes === 'function') {
