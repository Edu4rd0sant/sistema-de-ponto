<?php 
// O controle de sessão e redirecionamento agora é feito no AuthController::index.
// Esta view apenas renderiza o formulário e erros via $_GET caso retornados pelo Controller.
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
...
<body class="bg-slate-900 text-slate-200 font-sans min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md bg-slate-800/80 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-2xl p-8 z-10 relative">
        <div class="text-center mb-8">
            <img src="/img/primuslogocompleta.png" alt="Primus Bank" class="h-16 mx-auto mb-6 brightness-0 invert opacity-90">
