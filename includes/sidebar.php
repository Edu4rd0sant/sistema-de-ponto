...
?>
<div id="sidebar-backdrop" class="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-20 hidden lg:hidden" onclick="toggleSidebar()"></div>
<aside id="admin-sidebar" class="w-64 bg-slate-900 border-r border-slate-800 h-screen fixed top-0 left-0 flex flex-col pt-8 pb-4 z-30 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out">
    ...
    <nav class="flex flex-col gap-1 px-4 flex-1">
        <a href="/admin" class="<?php echo getNavItemClass('admin.php', $current_page); ?>">
            <div class="flex items-center gap-3">
                <i class="ph ph-squares-four text-lg"></i>
                <span>Dashboard RH</span>
            </div>
        </a>
        <a href="/admin/gestao_ponto" class="<?php echo getNavItemClass('gestao_ponto.php', $current_page); ?>">
            <div class="flex items-center gap-3">
                <i class="ph ph-clock-user text-lg"></i>
                <span>Gestão de Ponto</span> 
            </div>
        </a>
        <a href="/admin/escalas" class="<?php echo getNavItemClass('escalas.php', $current_page); ?>">
            <div class="flex items-center gap-3">
        ...
        <a href="/admin/relatorios" class="<?php echo getNavItemClass('relatorios.php', $current_page); ?>">
            <div class="flex items-center gap-3">
        ...
        <?php endif; ?>
        <a href="/admin/perfil" class="<?php echo getNavItemClass('perfil_admin.php', $current_page); ?>">
            <div class="flex items-center gap-3">
