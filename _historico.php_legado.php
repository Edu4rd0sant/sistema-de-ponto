...
// Buscar histórico de ponto do funcionário logado
try {
    $stmt = $pdo->prepare("SELECT id, tipo, data_hora FROM registros_ponto WHERE usuario_id = :uid ORDER BY data_hora DESC");
    $stmt->bindParam(':uid', $usuario_id);
    $stmt->execute();
    $historico = $stmt->fetchAll(PDO::FETCH_ASSOC);
} catch (PDOException $e) {
    $historico = [];
    $erro_db = "Erro ao carregar histórico: " . $e->getMessage();
}
