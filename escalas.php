    ...
    <div class="flex w-full">
        ...
        <main class="flex-1 ml-64 flex flex-col min-h-screen relative overflow-hidden">
            ...
            <div class="p-8 pb-12 flex-1 relative z-10 flex flex-col">
                ...
                <div class="bg-slate-800/80 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-xl flex flex-col">
                    ...
                    <div class="p-6 border-b border-slate-700/50 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-slate-800 rounded-t-2xl">
                        ...
                        <button onclick="abrirModalEscala()" class="bg-blue-600 hover:bg-blue-500 text-white font-medium py-2.5 px-5 rounded-lg shadow-lg shadow-blue-500/20 transition-all hover:-translate-y-0.5 active:translate-y-0 flex items-center gap-2 whitespace-nowrap text-sm">
                            ...
                            <?php if(count($escalas) > 0): ?>
                                ...
                                <div class="group bg-slate-900/40 border border-slate-700 hover:border-blue-500/50 rounded-xl p-5 hover:bg-slate-800/60 transition-all hover:-translate-y-1 shadow-lg hover:shadow-blue-900/20">
                                    <div class="flex justify-between items-start mb-4">
                                        ...
                                        <button onclick="abrirModalExcluir(<?php echo $escala['id']; ?>)" class="text-slate-500 hover:text-red-400 opacity-0 group-hover:opacity-100 transition-opacity">
                                    ...
                                    <div class="pt-4 border-t border-slate-700/50 flex justify-between items-center">
                                        ...
                                        <button onclick="abrirModalEscala(<?php echo htmlspecialchars(json_encode($escala)); ?>)" class="text-blue-400 hover:text-blue-300 text-sm font-medium flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            <div id="modalEscala" class="fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[100] items-center justify-center p-4 hidden opacity-0 transition-opacity duration-300">
                <div class="bg-slate-800 border border-slate-700 w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden transform scale-95 transition-transform duration-300" id="modalEscalaContent">
                    ...
                    <form action="actions/salvar_escala.php" method="POST" id="formEscala" class="p-6">
            ...
            <div id="modalExcluirEscala" class="fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[100] items-center justify-center p-4 hidden opacity-0 transition-opacity duration-300">
                <div class="bg-slate-800 border border-slate-700 w-full max-w-sm rounded-2xl shadow-2xl overflow-hidden p-6 text-center transform scale-95 transition-transform duration-300" id="modalExcluirContent">
