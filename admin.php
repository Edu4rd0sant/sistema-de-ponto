    ...
    <div class="flex w-full">
        ...
        <main class="flex-1 ml-64 flex flex-col min-h-screen">
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="relative">
                                        ...
                                        <input type="text" placeholder="Buscar funcionário..." 
                                            class="w-64 bg-slate-900/50 border border-slate-700 rounded-lg pl-10 pr-4 py-2 text-sm text-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all placeholder:text-slate-500">
                                    </div>
                                    <button onclick="abrirModalNovoFuncionario()" class="bg-blue-600 hover:bg-blue-500 text-white text-sm font-medium py-2 px-4 rounded-lg shadow-lg shadow-blue-500/20 transition-all hover:-translate-y-0.5 active:translate-y-0 flex items-center gap-2 whitespace-nowrap">
            ...
            <div id="modalPonto" class="modal-overlay fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[100] items-center justify-center p-4">
                <div class="modal-content bg-slate-800 border border-slate-700 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden">
                    ...
                    <form action="actions/salvar_ponto_admin.php" method="POST" id="formAlterarPonto" class="p-6">
            ...
            <div id="modalNovoFuncionario" class="modal-overlay fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[100] items-center justify-center p-4">
                <div class="modal-content bg-slate-800 border border-slate-700 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden">
                    ...
                    <form action="actions/criar_funcionario.php" method="POST" id="formNovoFuncionario" class="p-6">
                        <div class="mb-4">
            ...
            <div id="modalResetSenha" class="modal-overlay fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[100] items-center justify-center p-4">
                <div class="modal-content bg-slate-800 border border-slate-700 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden">
                    ...
                    <form action="actions/resetar_senha_admin.php" method="POST" id="formResetSenha" class="p-6">
            ...
            <div id="modalEditarPermissoes" class="modal-overlay fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[100] items-center justify-center p-4">
                <div class="modal-content bg-slate-800 border border-slate-700 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden">
                    ...
                    <form action="actions/editar_permissoes.php" method="POST" id="formEditarPermissoes" class="p-6">
            ...
            <div id="modalExcluir" class="modal-overlay fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[100] items-center justify-center p-4">
                <div class="modal-content bg-slate-800 border border-slate-700 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden p-6 text-center">
            ...
            <div id="modalSolicitacoes" class="modal-overlay fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[100] items-center justify-center p-4">
                <div class="modal-content bg-slate-800 border border-slate-700 w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[80vh]">
